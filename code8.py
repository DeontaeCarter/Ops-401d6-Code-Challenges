#!/usr/bin/env python3
# Deontae Carter
# File Encrytption Script part 3 
# 4/26/23
# https://stackoverflow.com/questions/56974927/permission-denied-trying-to-run-python-on-windows-10, #ChatGPT helped with background
...
def change_desktop_background():
    imageUrl = "https://cdn-cybersecurity.att.com/images/uploads/cyber_risks.png"
